...
<head>
    ...
    <title>Votre déclaration Spotlight est publiée</title>
</head>
        ...
        <tr><td align="center">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                ...
                <tr><td style="padding:30px 28px;">
                    ...
                    @endif
                    @if ($instagramUrl)
                        <p style="margin:0 0 12px;"><a href="{{ $instagramUrl }}" style="color:#1664d9;">Voir la publication Instagram</a></p>
                    @endif
                    <p style="margin:22px 0 0;font-size:13px;line-height:1.6;color:#6b7280;">Les justificatifs privés de votre dossier ne figurent pas dans ces publications.</p>
                </td></tr>
                <tr><td style="border-top:1px solid #e5e7eb;padding:18px 28px;font-size:12px;color:#6b7280;">Spotlight, plateforme citoyenne de déclaration des pertes et découvertes.</td></tr>
            </table>
        </td></tr>
    </table>
</body>
